...
Route::controller(HomeController::class)->prefix('home/ajax')->group(function () {
    ...
    Route::get('/Rawdi', 'Rawdi')->name('homepage.Rawdi'); // featured courses
    Route::get('/Basic', 'Basic')->name('homepage.Basic'); // featured courses
    Route::get('/prep', 'Preparatory')->name('homepage.Preparatory'); // featured courses

    Route::get('/secondary', 'secondary')->name('homepage.secondary'); // featured courses

    Route::get('/Bilingualschools', 'Bilingualschools')->name('homepage.Bilingual-schools'); // featured courses
