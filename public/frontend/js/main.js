...
let rawdix = webUrl + "/" + apiEndpoint + "/Rawdi"; //http://onestacademy.test/home/ajax/featured-courses



let basic = webUrl + "/" + apiEndpoint + "/Basic"; //http://onestacademy.test/home/ajax/featured-courses

let Preparatory_ = webUrl + "/" + apiEndpoint + "/prep"; //http://onestacademy.test/home/ajax/featured-courses

let secondaryx = webUrl + "/" + apiEndpoint + "/secondary"; //http://onestacademy.test/home/ajax/featured-courses
let Bilingualschoolsx = webUrl + "/" + apiEndpoint + "/Bilingualschools"; //http://onestacademy.test/home/ajax/featured-courses
...
async function Bilingualschools() {
    await $.ajax({
        url: Bilingualschoolsx,
        method: "get",
        data: {},
        success: function (data) {
            if (data?.result) {
                $("#Bilingualschools").html(data?.data?.content);
            }
        }
    });
}
...
async function secondary() {
    await $.ajax({
        ...
        success: function (data) {
            if (data?.result) {
                $("#secondary").html(data?.data?.content);
            }
        }
    });
}
...
$(document).ready(function () {
    ...
    $(".ot-latest-courses-area").length > 0 && Rawdi();
    $(".ot-courses-area").length > 0 && Basic();
       $(".ot-latest-courses-area").length > 0 && prep();
        $(".ot-courses-area").length > 0 && secondary();
        $(".ot-courses-area").length > 0 && Bilingualschools();
