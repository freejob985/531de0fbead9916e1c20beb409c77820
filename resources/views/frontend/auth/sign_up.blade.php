...
<style>
  ...
  <div class="position-relative ot-contact-form mb-24"  style="
...
">
                                ...
                                <input class="form-control ot-contact-input" name="longitude" type="text" id="longitude"
...
">
                                ...
                                <input class="form-control ot-contact-input" id="latitude" name="latitude" type="text"
                                    placeholder="{{ ___('student.Enter name') }}" aria-label="default input example">
                                <span class="text-danger custom-error-text" id="error_name"></span>
...
<div class="position-relative ot-contact-form mb-24">
    <label for="userType" class="ot-contact-label">
        {{ ___('student.User Type') }}
        <span class="text-danger">*</span>
    </label>
    <select class="form-control ot-contact-input" name="Type" id="userType">
        <option value="student">{{ ___('student.Student') }}</option>
        <option value="parent">{{ ___('student.Parent') }}</option>
    </select>
    <span class="text-danger custom-error-text" id="error_user_type"></span>
</div>
